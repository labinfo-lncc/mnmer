...
The mnmer function generates a feature matrix that may be used to conduct clustering or classification. Independent of the mnmer package, the feature matrix may be analyzed using a variety of methods within the R system.

The documentation example demonstrates one of the available methodologies applied to one of the potential research issues.
...
To view the model's output in the form of performance metrics, MLeval (https://cran.r-project.org/web/packages/MLeval/index.html) is utilized.

This sample is greatly personalized by the user. It may be carried out using various (m,n)-mer, data splitting, control parameters, classification methods, and/or hyper parametrization.

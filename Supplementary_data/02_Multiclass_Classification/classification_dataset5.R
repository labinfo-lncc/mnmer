...
#### read random FASTA
        ...
        g1 <- mnmer::readNumFASTA("../01_Raw_data/dataset5/Bacteria_vir_subset.fasta",500,TRUE,0.02)
        g2 <- mnmer::readNumFASTA("../01_Raw_data/dataset5/Plant_vir_subset.fasta",500,TRUE,0.02)
        g3 <- mnmer::readNumFASTA("../01_Raw_data/dataset5/Arthropoda_vir_subset.fasta",500,TRUE,0.02)
        g4 <- mnmer::readNumFASTA("../01_Raw_data/dataset5/Mammalia_vir_subset.fasta",500,TRUE,0.02)
	
#### feature matrix
	
	class3 <- mnmer(g3, 3,1)
	classes <- replicate(nrow(class3), "Arthropoda_vir_subset")
	class3 <- cbind(class3, classes)

	class1 <- mnmer(g1, 3,1)
	classes <- replicate(nrow(class1), "Bacteria_vir_subset")
	class1 <- cbind(class1, classes)

	class2 <- mnmer(g2, 3,1)
	classes <- replicate(nrow(class2), "Plant_vir_subset")
	class2 <- cbind(class2, classes)
	
	class4 <- mnmer(g4, 3,1)
	classes <- replicate(nrow(class4), "Mammalia_vir_subset")
...
### write tables
write.csv(AUC, file="../03_Metrics/AUC_dataset5_31.txt", row.names=F)
write.csv(overall_knn, file="../03_Metrics/Accuracy_knn_dataset5_31.txt", row.names=F)
write.csv(overall_sda, file="../03_Metrics/Accuracy_sda_dataset5_31.txt", row.names=F)
write.csv(overall_pda, file="../03_Metrics/Accuracy_pda_dataset5_31.txt", row.names=F)
write.csv(overall_rf, file="../03_Metrics/Accuracy_rf_dataset5_31.txt", row.names=F)
write.csv(overall_C5, file="../03_Metrics/Accuracy_C5_dataset5_31.txt", row.names=F)
write.csv(byClass_knn, file="../03_Metrics/byClass_knn_dataset5_31.txt", row.names=F)
write.csv(byClass_sda, file="../03_Metrics/byClass_sda_dataset5_31.txt", row.names=F)
write.csv(byClass_pda, file="../03_Metrics/byClass_pda_dataset5_31.txt", row.names=F)
write.csv(byClass_rf, file="../03_Metrics/byClass_rf_dataset5_31.txt", row.names=F)
write.csv(byClass_C5, file="../03_Metrics/byClass_C5_dataset5_31.txt", row.names=F)

rm(AUC, AUC_knn, AUC_pda, AUC_rf, AUC_sda, AUC_C5, class1, class2)

#save.image("dataset5.RData")
...
### write tables
write.csv(AUC, file="../03_Metrics/AUC_dataset5_40.txt", row.names=F)
write.csv(overall_knn, file="../03_Metrics/Accuracy_knn_dataset5_40.txt", row.names=F)
write.csv(overall_sda, file="../03_Metrics/Accuracy_sda_dataset5_40.txt", row.names=F)
write.csv(overall_pda, file="../03_Metrics/Accuracy_pda_dataset5_40.txt", row.names=F)
write.csv(overall_rf, file="../03_Metrics/Accuracy_rf_dataset5_40.txt", row.names=F)
write.csv(overall_C5, file="../03_Metrics/Accuracy_C5_dataset5_40.txt", row.names=F)
write.csv(byClass_knn, file="../03_Metrics/byClass_knn_dataset5_40.txt", row.names=F)
write.csv(byClass_sda, file="../03_Metrics/byClass_sda_dataset5_40.txt", row.names=F)
write.csv(byClass_pda, file="../03_Metrics/byClass_pda_dataset5_40.txt", row.names=F)
write.csv(byClass_rf, file="../03_Metrics/byClass_rf_dataset5_40.txt", row.names=F)
write.csv(byClass_C5, file="../03_Metrics/byClass_C5_dataset5_40.txt", row.names=F)
...
### write tables
write.csv(AUC, file="../03_Metrics/AUC_dataset5_22.txt", row.names=F)
write.csv(overall_knn, file="../03_Metrics/Accuracy_knn_dataset5_22.txt", row.names=F)
write.csv(overall_sda, file="../03_Metrics/Accuracy_sda_dataset5_22.txt", row.names=F)
write.csv(overall_pda, file="../03_Metrics/Accuracy_pda_dataset5_22.txt", row.names=F)
write.csv(overall_rf, file="../03_Metrics/Accuracy_rf_dataset5_22.txt", row.names=F)
write.csv(overall_C5, file="../03_Metrics/Accuracy_C5_dataset5_22.txt", row.names=F)
write.csv(byClass_knn, file="../03_Metrics/byClass_knn_dataset5_22.txt", row.names=F)
write.csv(byClass_sda, file="../03_Metrics/byClass_sda_dataset5_22.txt", row.names=F)
write.csv(byClass_pda, file="../03_Metrics/byClass_pda_dataset5_22.txt", row.names=F)
write.csv(byClass_rf, file="../03_Metrics/byClass_rf_dataset5_22.txt", row.names=F)
write.csv(byClass_C5, file="../03_Metrics/byClass_C5_dataset5_22.txt", row.names=F)
rm(AUC, AUC_knn, AUC_pda, AUC_rf, AUC_sda, AUC_C5, class1, class2)
...
### write tables
write.csv(AUC, file="../03_Metrics/AUC_dataset5_13.txt", row.names=F)
write.csv(overall_knn, file="../03_Metrics/Accuracy_knn_dataset5_13.txt", row.names=F)
write.csv(overall_sda, file="../03_Metrics/Accuracy_sda_dataset5_13.txt", row.names=F)
write.csv(overall_pda, file="../03_Metrics/Accuracy_pda_dataset5_13.txt", row.names=F)
write.csv(overall_rf, file="../03_Metrics/Accuracy_rf_dataset5_13.txt", row.names=F)
write.csv(overall_C5, file="../03_Metrics/Accuracy_C5_dataset5_13.txt", row.names=F)
write.csv(byClass_knn, file="../03_Metrics/byClass_knn_dataset5_13.txt", row.names=F)
write.csv(byClass_sda, file="../03_Metrics/byClass_sda_dataset5_13.txt", row.names=F)
write.csv(byClass_pda, file="../03_Metrics/byClass_pda_dataset5_13.txt", row.names=F)
write.csv(byClass_rf, file="../03_Metrics/byClass_rf_dataset5_13.txt", row.names=F)
write.csv(byClass_C5, file="../03_Metrics/byClass_C5_dataset5_13.txt", row.names=F)

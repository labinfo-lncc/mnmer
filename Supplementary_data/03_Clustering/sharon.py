...
FULL_FILE = "/home/aandrade/mnmer/teste/sharon_13mer.csv"
print(FULL_FILE)
...
mainMetrics = pd.concat([metrics6, mainMetrics])
mainMetrics.to_csv("metrics_sharon_22mer.csv", sep=',')

del db,mn,algorithm,homogeneity,completeness,vmeasure,adjrand,adjmutual,silhouette,metrics6,FULL_FILE,data,label,X,y

# %%
FULL_FILE = "/home/aandrade/mnmer/teste/sharon_31mer.csv"
print(FULL_FILE)
...
mainMetrics = pd.concat([metrics6, mainMetrics])
mainMetrics.to_csv("metrics_sharon_31mer.csv", sep=',')

del db,mn,algorithm,homogeneity,completeness,vmeasure,adjrand,adjmutual,silhouette,metrics6,FULL_FILE,data,label,X,y

# %%
FULL_FILE = "/home/aandrade/mnmer/teste/sharon_40mer.csv"
print(FULL_FILE)
...
mainMetrics = pd.concat([metrics6, mainMetrics])
mainMetrics.to_csv("metrics_sharon_40mer.csv", sep=',')
